...
if (ddmStructureId > 0) {
	...
	ddmStructure = DDMStructureLocalServiceUtil.fetchStructure(scopeGroupId, PortalUtil.getClassNameId(JournalArticle.class), structureId);

	if (ddmStructure == null) {
		ddmStructure = DDMStructureLocalServiceUtil.fetchStructure(themeDisplay.getCompanyGroupId(), PortalUtil.getClassNameId(JournalArticle.class), structureId);
	}
}
